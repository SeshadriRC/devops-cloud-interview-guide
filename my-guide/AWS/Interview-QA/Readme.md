**we are a e-commerce company and you know we have customers over the globe so we actually use multi-reion deployments have you ever worked on multi-region deployments if yes can you talk about multi-region deployments and how to achieve that**
